...
const Profile = () => {
    ...
    return (
        <div className="min-h-[70vh] w-full items-center grid grid-cols-1 md:grid-cols-2 gap-4 bg-black p-4">
            <div className="flex flex-col items-center">
                ...
                <Link to={`edit`}>
                    <button className="bg-pink-600 hover:bg-[#0B1930] transition-all duration-200 text-white py-2 px-4 rounded mt-4 cursor-pointer">
                        Edit Profile
                    </button>
                </Link>
            </div>
            ...
            <div className="flex flex-col gap-2">
                <div className="mb-4">
                    <p className="block text-pink-600 text-2xl font-bold mb-2">Full Name:</p>
                    <p className="text-white text-xl font-normal">{user?.username}</p>
                </div>
                <div className="mb-4">
                    <p className="block text-pink-600 text-2xl font-bold mb-2">Email:</p>
                    <p className="text-white text-xl font-normal">{user?.email}</p>
                </div>
                <div className="mb-4">
                    <p className="block text-pink-600 text-2xl font-bold mb-2">Joined On:</p>
