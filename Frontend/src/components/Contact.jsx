    ...
    return (
        <div className="flex flex-col items-center mx-auto px-4 py-16">
            ...
            <div className="flex flex-row gap-2 w-full items-center justify-center my-4">
                <Link to={"https://github.com/Vermasaiyam"} target="blank" title="Github" className="bg-white flex items-center justify-center hover:bg-gray-100 p-2 rounded-full">
                    <Github className="w-6 h-6" />
                </Link>
                <Link to={"https://www.linkedin.com/in/saiyam05/"} target="blank" title="LinkedIn" className="bg-white flex items-center justify-center hover:bg-gray-100 p-2 rounded-full">
                    <Linkedin className="w-6 h-6" />
                </Link>
                <Link to={"https://x.com/SaiyamVerm91813/"} target="blank" title="X" className="bg-white flex items-center justify-center hover:bg-gray-100 p-2 rounded-full">
                    <X className="w-6 h-6" />
                </Link>
                <Link to={"https://www.instagram.com/s.verma0504/"} target="blank" title="Instagram" className="bg-white flex items-center justify-center hover:bg-gray-100 p-2 rounded-full">
